...
export const GoogleDriveIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M7.71 3.5L1.15 15l3.858 6.5L12 9.5 7.71 3.5z" fill="#0066DA"/>
        <path d="M20.29 3.5L12 9.5l4.29 6h8.57l4.29-6.5-8.86-5.5z" fill="#00AC47"/>
        <path d="M4.008 21.5l3.858-6.5H19.29l-3.858 6.5H4.008z" fill="#EA4335"/>
    </svg>
);
